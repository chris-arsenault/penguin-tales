...
export type LoreRecordType = 'name' | 'description' | 'era_narrative' | 'relationship_backstory' | 'tech_magic' | 'discovery_event' | 'chain_link' | 'entity_change';
...
export interface EnrichmentContext {
    graphSnapshot: {
        ...
        historicalRelationships?: Relationship[];
    };
