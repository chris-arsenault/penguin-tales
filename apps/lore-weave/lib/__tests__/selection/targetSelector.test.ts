...
import { TargetSelector, SelectionBias, SelectionContext } from '../../selection/targetSelector';
...
describe('TargetSelector', () => {
  ...
  beforeEach(() => {
    ...
    _entities.set('npc1', createEntity('npc1', 'npc', 'merchant', { tags: { trader: 'true' }, prominence: 'marginal' }));
    _entities.set('npc2', createEntity('npc2', 'npc', 'hero', { tags: { brave: 'true' }, prominence: 'renowned' }));

    // Medium-degree nodes (3-4 connections)
    _entities.set('npc3', createEntity('npc3', 'npc', 'merchant', { tags: { wealthy: 'true' }, prominence: 'recognized' }));

    // High-degree hub (6+ connections) - should be penalized
    _entities.set('npc4', createEntity('npc4', 'npc', 'leader', { tags: { popular: 'true' }, prominence: 'mythic' }));
  ...
  describe('selectTargets - preference biases', () => {
    ...
    it('should prefer specified tags', () => {
      ...
      expect('brave' in result.existing[0].tags).toBe(true);
    });
    ...
    it('should prefer same location as reference entity', () => {
      ...
      const npc5 = createEntity('npc5', 'npc', 'merchant', { tags: { trader: 'true' }, prominence: 'marginal' });
