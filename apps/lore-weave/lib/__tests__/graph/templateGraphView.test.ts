...
describe('TemplateGraphView', () => {
  ...
  // Note: getLocation, getFactionMembers, and getFactionLeader methods were removed from TemplateGraphView.
  // Use getRelated() or findRelationships() with appropriate relationship kinds instead.
