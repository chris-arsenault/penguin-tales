 ...
 *
 * Coherence Bench is an MFE remote - it does not function as a standalone app.
...
import './CoherenceBenchRemote.jsx';
...
if (root) {
  root.innerHTML = `
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; background: #1e1e2e; color: #e0e0e0; font-family: system-ui, sans-serif; text-align: center; padding: 40px;">
      <h1 style="color: #a78bfa; margin-bottom: 16px;">Coherence Bench</h1>
      <p style="color: #888; max-width: 400px;">
        Coherence Bench is part of The Canonry suite and runs as a module federation remote.
      </p>
      <p style="color: #666; margin-top: 16px; font-size: 14px;">
        To use Coherence Bench, please run The Canonry instead:<br/>
